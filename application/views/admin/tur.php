<div class="col-md-12 col-sm-12">
          ...
          <td><?= $no?></td>
          <td><?= $l->nama_paket?></td>
          <td><img class="preview-img" src="<?=base_url();?>assets/image/<?= $l->image?>" ></img></td>
          <td><?= $l->fasilitas_1?></td>
          <td><?= $l->fasilitas_2?></td>
          <td><?= $l->fasilitas_3?></td>
          <td><?= $l->fasilitas_4?></td>
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?=base_url();?>index.php/kasembon/addtur" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="<?=base_url();?>index.php/kasembon/updatetur" method="post" enctype="multipart/form-data">
      <div class="form-group">
