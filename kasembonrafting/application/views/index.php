                ...
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s">
                        <div class="single-icon">
                            <img src="<?= base_url();?>assets/images/<?= $t->image?>" width="80" height="80" style="border-radius:50px; object-fit:cover;" alt="">
                        </div>
                        <!-- <h4></h4> -->
                        <p><?= $t->deskripsi?></p>
                    </div>
                    ...
                    <div class="app_screenshots_slides owl-carousel">
                        <?php foreach($galeri as $g){?>
                            <div class="single-shot">
                                <img style="width:250px;height:200px;object-fit:cover;" src="<?=base_url();?>assets/image_galeri/<?= $g->image?>" alt="<?= $g->caption?>" id="myImg<?=$g->id_gambar;?>" class="myImg">
                            </div>
                        <?php }?>
                    </div>
                </div>
